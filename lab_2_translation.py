...
def translation(list_of_homogeneous_coordinate, no_of_coord):
    ...
    matrix_for_translation = [1,0,tx,0,1,ty,0,0,1]
    matrix_for_translation = np.asarray(matrix_for_translation).reshape(3,3)
    for i in range(len(list_of_homogeneous_coordinate)):
        new_translated_coordinate.append(np.dot(matrix_for_translation, list_of_homogeneous_coordinate[i]))
    ...
    translated_homogeneous_coordinate = convert_to_hc(translated_x_coordinate, translated_y_coordinate, no_of_coord)
...
scaled_homogeneous_coordinates = translation(original_homogeneous_coordinate, no_of_coord)
